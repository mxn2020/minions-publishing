...
/**
 * @minions-publishing/cli — CLI for Minions Publishing
 *
...
import { customTypes } from '@minions-publishing/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Publishing'));
        console.log(chalk.dim('Platform credentials, publish queue, and post receipts'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-publishing/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-publishing/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-publishing')}`);
